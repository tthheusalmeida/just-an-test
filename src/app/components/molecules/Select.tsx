    ...
    <div className="relative w-full max-w-xs group">
      ...
      <button
        ...
        className={mergeClassNames(
          ...
          isOpen
            ? "border-darkTurquoise-700"
            : "border-[var(--color-foreground)]/25 hover:border-darkTurquoise-700"
        )}
      >
        <span
          className={mergeClassNames(
        ...
        <FiChevronDown
          size={24}
          className={`transition-all duration-300 text-[var(--color-foreground)]/25 group-hover:text-darkTurquoise-700 ${
